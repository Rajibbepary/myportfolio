...
const Skill = () => {
    return (
        ...
        <div>
          ...
          <span className="font-Philosopher text-white">My Skills</span>
          </h2>
        </div>
        <div>
          <Marquee>
            <div className="flex flex-col gap-10 mt-3">
              ...
              <div className="flex justify-center items-center gap-6">
                <img src={html} alt="HTML logo" className="w-24 h-24 bg-[#FFFFFF] rounded-lg border border-gray-300 p-2 shadow-lg hover:scale-105 transition-transform" />
                <img src={css} alt="CSS logo" className="w-24 bg-[#FFFFFF] h-24 rounded-lg border border-gray-300 p-2 shadow-lg hover:scale-105 transition-transform" />
              ...
              <div className="flex justify-center items-center gap-6">
                ...
                <img src={github} alt="GitHub logo" className="w-24 bg-[#FFFFFF] h-24 rounded-lg border border-gray-300 p-2 shadow-lg hover:scale-105 transition-transform" />
